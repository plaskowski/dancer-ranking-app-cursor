...
class EventFileSelectionStep extends StatelessWidget {
  ...
  Future<void> _pickFile() async {
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        ActionLogger.logUserAction('EventFileSelectionStep', 'file_selected', {
      ...
      // Error handling will be done by parent dialog
      rethrow;
    }
  }
}
