...
class DancerService {
  ...
  Stream<List<Dancer>> watchActiveDancers() => _crudService.watchActiveDancers();
  ...
  // Archival Methods
  Future<bool> archiveDancer(int dancerId) => _crudService.archiveDancer(dancerId);

  Future<bool> reactivateDancer(int dancerId) => _crudService.reactivateDancer(dancerId);

  Future<List<Dancer>> getArchivedDancers() => _crudService.getArchivedDancers();

  // Search Methods
  Stream<List<Dancer>> searchDancers(String query) => _searchService.searchDancers(query);

  Stream<List<Dancer>> searchActiveDancers(String query) => _searchService.searchActiveDancers(query);
  ...
  Future<List<DancerWithTags>> getActiveDancersWithTags() => _tagService.getActiveDancersWithTags();

  Stream<List<DancerWithTags>> watchActiveDancersWithTags() => _tagService.watchActiveDancersWithTags();

  Stream<List<DancerWithTags>> watchArchivedDancersWithTags() => _tagService.watchArchivedDancersWithTags();
